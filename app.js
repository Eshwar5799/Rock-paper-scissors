...
function ConverttoWord(letter) {
    // Keep this function for now in case you want to do any processing on the words later on
    // It was just returning letter anyway, may as well simplify it to that
    return letter;
}
